    ...
    return (
        <div className="header">
            <div className="header-application-title-container">
                ...
                <div className="header-application-title-text">Simple Movie Editor and FFMPEG CLI Generator</div>
            </div>

            <div className="header-button-container">
                <a className="header-button-link" href="https://github.com/w-okada/ffmpeg-cli-gen-js" target="_blank" rel="noopener noreferrer">
