...
const FrontPageDescriptionJp = () => {
    return (
        <div className="front-description">
            <p>
                ブラウザで映像編集を行うアプリケーションです。
                ブラウザ単体で動くため、専用のアプリケーションのインストールは不要です。また、サーバとの通信も発生しないため通信負荷を気にする必要がありません。
            </p>
            <p>
                内部処理にffmpeg.wasmを使用しています。ffmpeg.wasmはあまり高速ではないので、重い処理は表示されるffmpegのコマンドをローカルPC上で実行することをお勧めします。
            </p>
            <p>
                ソースコード、使用方法は
...
const FrontPageDescriptionEn = () => {
    return (
        <div className="front-description">
            <p>
                Edit your movie with your browser!
            </p>
            <p>
            ...
            <p>
                This application uses ffmpeg.wasm. ffmpeg.wasm is not very fast, so it is recommended to execute the displayed ffmpeg command on a local PC for heavy processing.
            </p>
            <p>
        ...
        return (
            <div className="front-container">
                <div className="front-title">
                    <p>Simple Movie Editor</p>
                    <p>and</p>
                    <p>FFMPEG CLI Generator</p>
